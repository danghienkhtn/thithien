 ...
 * @todo        :   Fan
 */
class Core_Business_Nosql_Mongo {
...
/**
	...
	*/
	...
	public function __construct(){
		...
		$this->connect($configuration->system->nosql->mongo->toArray());	
	}
	...
	private function connect($config){
		try{
	        ...
	        $connection = new Mongo('mongodb://admin:admin@192.168.38.104:27017/admin');
	    	return $this->db = $connection->selectDB('admin');
		}catch(Exception $e) {
