...
/**
 * @author      :   Linuxpham
 * @name        :   Core_Sharding_Adapter_Ring
 * @version     :   201008
 * @copyright   :   My company
 * @todo        :   Using to shading storage
 */
class Core_Sharding_Adapter_Ring extends Core_Sharding_Adapter_Abstract
{
    /**
    * Constructor
    * @param array $options
    ...
    */
    ...
    protected function getMap($key)
    {
        ...
        $key = sprintf("%u\n", crc32($key));
        $position = abs($key) % $this->hashring_count;
