...
class Core_Visitor
{
    ...
    */
    ...
    {          
        ...
        {
            throw new Zend_Exception("No host when call Core_Visitor");
        }
        ...
        $options = array(
            ...
            'thrift'    =>  array(
                ...
                'callback'  =>  'gnt_mobion_storage_mobionrecentvisitor_RecentVisitorServiceClient',
                'package'   =>  'Visitor',
                'idc'       =>  $options['idc'],
