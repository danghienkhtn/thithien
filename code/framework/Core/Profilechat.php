...
/**
 * @author      :   Linuxpham
 * @name        :   Core_Profilechat
 * @version     :   201209
 * @copyright   :   My company
 * @todo        :   Using to Core_Profile data
 */
class Core_Profilechat
{
	/**
     * List instance
     *
    ...
    */
    ...
    {          
        ...
        {
            throw new Zend_Exception("No host when call Core_Joined");
        }
        ...
        $options = array(
            ...
            'thrift'    =>  array(
                ...
                'callback'  =>  'profileForChatServiceClient',
                'package'   =>  'Profilechat',
                'idc'       =>  $options['idc'],
