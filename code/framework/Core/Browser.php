...
class Core_Browser
{
     ...
     * @return <object>
     */
    public final static function getInstance($useragent="")
    {
        //Check instance
        if(is_null(self::$_instance))
        {
            self::$_instance = new self($useragent);
        }
    ...
    */
    ...
    /**
    * Is the browser from a feature mobile device?
    * @return boolean True if the browser is from a mobile device otherwise false
    */
    public function isFeatureMobile() 
    {         
        //Get platform name
        $platformName =  $this->getPlatform();
        
        //Check platform name
        if(($platformName == Core_Browser::PLATFORM_APPLE) || ($platformName == Core_Browser::PLATFORM_LINUX) || ($platformName == Core_Browser::PLATFORM_WINDOWS) || ($platformName == Core_Browser::PLATFORM_IPAD) || ($platformName == Core_Browser::PLATFORM_IPHONE) || ($platformName == Core_Browser::PLATFORM_IPOD))
        {
            return false;
        }
        ...
        //Check browser name
        if(($browserName == Core_Browser::BROWSER_SAFARI) || ($browserName == Core_Browser::BROWSER_CHROME) || ($browserName == Core_Browser::BROWSER_ANDROID) || ($browserName == Core_Browser::BROWSER_IPAD) || ($browserName == Core_Browser::BROWSER_IPHONE) || ($browserName == Core_Browser::BROWSER_IPOD))
        {
            return false;
        }
