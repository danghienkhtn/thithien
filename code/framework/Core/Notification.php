 ...
 * @todo        :   Using to notification data
 */
class Core_Notification
{
    ...
    */
    ...
    {          
        ...
        {
            throw new Zend_Exception("No host when call Core_Notification");
        }
        ...
        $options = array(
            ...
            'thrift'    =>  array(
                ...
                'callback'  =>  'gnt_mobion_notification_MBNotificationServiceClient',
