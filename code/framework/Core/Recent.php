...
class Core_Recent
{
    ...
    */
    ...
    {          
        ...
        {
            throw new Zend_Exception("No host when call Core_Recent");
        }
        ...
        $options = array(
            ...
            'thrift'    =>  array(
                ...
                'callback'  =>  'gnt_mobion_storage_mobionuserrecentstorage_UserRecentStorageServiceClient',
                'package'   =>  'Recent',
                'idc'       =>  $options['idc'],
