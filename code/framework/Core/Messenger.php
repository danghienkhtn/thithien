 ...
 * @todo        :   Using to messenger data
 */
class Core_Messenger
{
	/**
     * List instance
     *
    ...
    */
    ...
    {          
        ...
        {
            throw new Zend_Exception("No host when call Core_Messenger");
        }
        ...
        $options = array(
            ...
            'thrift'    =>  array(
                ...
                'callback'  =>  'gnt_mobion_messenger_MBMessengerServiceClient',
                'package'   =>  'Messenger',
                'idc'       =>  $options['idc'],
