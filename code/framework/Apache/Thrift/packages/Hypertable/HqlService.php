 ...
 */
include_once $GLOBALS['THRIFT_ROOT'].'/packages/Hypertable/Hql_types.php';
include_once $GLOBALS['THRIFT_ROOT'].'/packages/Hypertable/ClientService.php';
...
interface HqlServiceIf extends ClientServiceIf {
  ...
  public function hql_exec2($command, $noflush, $unbuffered);
  public function hql_query2($command);
}
...
class HqlServiceClient extends ClientServiceClient implements HqlServiceIf {
  ...
  public function hql_exec2($command, $noflush, $unbuffered)
  {
    $this->send_hql_exec2($command, $noflush, $unbuffered);
    return $this->recv_hql_exec2();
  }

  public function send_hql_exec2($command, $noflush, $unbuffered)
  {
    $args = new Hypertable_ThriftGen_HqlService_hql_exec2_args();
    $args->command = $command;
    $args->noflush = $noflush;
    $args->unbuffered = $unbuffered;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Hypertable_ThriftGen_HqlService_hql_exec2_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new Hypertable_ThriftGen_HqlService_hql_exec2_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function hql_query2($command)
  {
    $this->send_hql_query2($command);
    return $this->recv_hql_query2();
  }

  public function send_hql_query2($command)
  {
    $args = new Hypertable_ThriftGen_HqlService_hql_query2_args();
    $args->command = $command;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Hypertable_ThriftGen_HqlService_hql_query2_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new Hypertable_ThriftGen_HqlService_hql_query2_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class Hypertable_ThriftGen_HqlService_hql_exec2_args {
  static $_TSPEC;
...
class Hypertable_ThriftGen_HqlService_hql_exec2_result {
  static $_TSPEC;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new Hypertable_ThriftGen_HqlResult2();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class Hypertable_ThriftGen_HqlService_hql_query2_args {
  static $_TSPEC;
...
class Hypertable_ThriftGen_HqlService_hql_query2_result {
  static $_TSPEC;
