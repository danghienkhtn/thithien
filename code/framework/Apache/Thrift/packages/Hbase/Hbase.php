      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem114 = null;
              $elem114 = new Mutation();
              $xfer += $elem114->read($input);
              $this->mutations []= $elem114;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->mutations !== null) {
      ...
      $xfer += $output->writeFieldBegin('mutations', TType::LST, 3);
      {
        ...
        {
          foreach ($this->mutations as $iter115)
          {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem121 = null;
              $elem121 = new Mutation();
              $xfer += $elem121->read($input);
              $this->mutations []= $elem121;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->mutations !== null) {
      ...
      $xfer += $output->writeFieldBegin('mutations', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRUCT, count($this->mutations));
        {
          foreach ($this->mutations as $iter122)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem128 = null;
              $elem128 = new BatchMutation();
              $xfer += $elem128->read($input);
              $this->rowBatches []= $elem128;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->rowBatches !== null) {
      ...
      $xfer += $output->writeFieldBegin('rowBatches', TType::LST, 2);
      {
        ...
        {
          foreach ($this->rowBatches as $iter129)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem135 = null;
              $elem135 = new BatchMutation();
              $xfer += $elem135->read($input);
              $this->rowBatches []= $elem135;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->rowBatches !== null) {
      ...
      $xfer += $output->writeFieldBegin('rowBatches', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->rowBatches));
        {
          foreach ($this->rowBatches as $iter136)
          {
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 4);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter150)
          {
  ...
  public function write($output) {
    ...
    if ($this->columns !== null) {
      ...
      $xfer += $output->writeFieldBegin('columns', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->columns));
        {
          foreach ($this->columns as $iter164)
          {
