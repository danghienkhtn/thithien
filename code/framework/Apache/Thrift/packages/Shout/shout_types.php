...
class gnt_server_shoutDetail {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('shoutDetail');
...
class gnt_server_scopeShoutFeed {
  static $_TSPEC;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('scopeShoutFeed');
...
class gnt_server_scopeShoutComment {
  static $_TSPEC;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('scopeShoutComment');
