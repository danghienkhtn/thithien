...
class TSocket extends TTransport {
  ...
  public function read($len) {
    ...
    /*Hoapt fixed*/  
    $iRetry = 0;
    while((($readable === 0) || ($this->handle_ == null)) && ($iRetry < 2)) {
        //Try to close the old socket
        @fclose($this->handle_);
        $this->handle_ = null;
  ...
  public function write($buf) {
    ...
    while (strlen($buf) > 0) {
      ...
      /*Hoapt fixed*/  
      $iRetry = 0;
      while((($writable === 0) || ($this->handle_ == null)) && ($iRetry < 2)) {
            //Try to close the old socket
            @fclose($this->handle_);
            $this->handle_ = null;
